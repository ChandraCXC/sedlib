...
/***********************************************************************
*
* File: TestCharacterizationIO.java
*
...
/**
   Tests Sedlib ability to create, read and write the Characterization objects
*/	

public class TestCharacterizationIO extends SedTestBase
{
    Sed m_sed = null;
    String m_fname = null;
    boolean keep = true;
    ...
    public TestCharacterizationIO( String name )
    {
	super(name);
    }
    ...
    {
	TestSuite suite = new TestSuite( TestCharacterizationIO.class );
    ...
    /**
     *  Tests ability to create and serialize Characterization objects
     *  <p>
     *  Create a new Characterization object which is fully defined
     *  and populated with values.  Write this object out in
     *  each of the supported formats.  
     */
    public void testCharacterization_new()
    {
	String testName = "testCharacterization_new";
...
*/
	...
	/* Characterization resides within the Characterization object..
	   create empty tree to this object. */
	segment.setChar( CompleteObjects.createCharacterization() );


	/* Write SED with Characterization to file in each of the supported formats */
	for (SedFormat format : SedFormat.values())
	{
if (format == SedFormat.XML)
   continue;
	    m_fname = "Characterization." + format.exten();
    ...
    /**
     *  Tests ability to load Characterization objects from VOT format
     *  <p>
     *  Load file containing a fully defined Characterization object
     ...
     */
    public void testCharacterization_copyVOT()
    {
	String testName = "testCharacterization_copyVOT";
	System.out.println("   run "+testName+"()");
    ...
    /**
     *  Tests ability to load Characterization objects from FITS format
     *  <p>
     *  Load file containing a fully defined Characterization object
     *  and write the object back out in the same format.
     *  If all information is extracted properly, the output file
     *  should identically match the input.
     */
    public void testCharacterization_copyFITS()
    {
	String testName = "testCharacterization_copyFITS";
	System.out.println("   run "+testName+"()");
    ...
    /**
     *  Tests ability to load Characterization objects from XML format
     *  <p>
     *  Load file containing a fully defined Characterization object
     *  and write the object back out in the same format.
     *  If all information is extracted properly, the output file
     *  should identically match the input.
     */
    public void estCharacterization_copyXML()
    {
	String testName = "testCharacterization_copyXML";
	System.out.println("   run "+testName+"()");
