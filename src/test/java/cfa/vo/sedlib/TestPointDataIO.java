...
/**
   Tests Sedlib ability to create, read and write the PointData objects
*/	

public class TestPointDataIO extends SedTestBase
{
    Sed m_sed = null;
    String m_fname = null;
    boolean keep = true;
    ...
    {
	TestSuite suite = new TestSuite( TestPointDataIO.class );
    ...
    /**
     *  Tests ability to create and serialize PointData objects
     *  <p>
     *  Create a new PointData object which is fully defined
     *  and populated with values.  Write this object out in
     *  each of the supported formats.  
     */
    public void testPointData_new()
    {
	String testName = "testPointData_new";
...
*/
	...
	List<Point> data = points.createPoint ();
	...
	/* Write SED with PointData to file in each of the supported formats */
	for (SedFormat format : SedFormat.values())
	{
if (format == SedFormat.XML)
   continue;
	    m_fname = "PointData." + format.exten();
    ...
    /**
     *  Tests ability to load PointData objects from VOT format
     *  <p>
     *  Load file containing a fully defined PointData object
     ...
     */
    public void testPointData_copyVOT()
    {
	String testName = "testPointData_copyVOT";
	System.out.println("   run "+testName+"()");
    ...
    /**
     *  Tests ability to load PointData objects from FITS format
     *  <p>
     *  Load file containing a fully defined PointData object
     *  and write the object back out in the same format.
     *  If all information is extracted properly, the output file
     *  should identically match the input.
     */
    public void testPointData_copyFITS()
    {
	String testName = "testPointData_copyFITS";
	System.out.println("   run "+testName+"()");
    ...
    /**
     *  Tests ability to load PointData objects from XML format
     *  <p>
     *  Load file containing a fully defined PointData object
     *  and write the object back out in the same format.
     *  If all information is extracted properly, the output file
     *  should identically match the input.
     */
    public void estPointData_copyXML()
    {
	String testName = "testPointData_copyXML";
	System.out.println("   run "+testName+"()");
