...
public class Utypes
{
    ...
    static protected final int max_enum = 370;
    ...
    static public final int   SEG_DATA_FLUXAXIS_UNIT                    = 294;
    static public final int   SEG_DATA_FLUXAXIS_UCD                     = 295;
    static public final int   SEG_DATA_FLUXAXIS_QUALITY                 = 296;
    static public final int   SEG_DATA_FLUXAXIS_ACC                     = 297;
    static public final int   SEG_DATA_FLUXAXIS_ACC_BINLOW              = 298;
    static public final int   SEG_DATA_FLUXAXIS_ACC_BINHIGH             = 299;
    static public final int   SEG_DATA_FLUXAXIS_ACC_BINSIZE             = 300;
    static public final int   SEG_DATA_FLUXAXIS_ACC_STATERRLOW          = 301;
    static public final int   SEG_DATA_FLUXAXIS_ACC_STATERRHIGH         = 302;
    static public final int   SEG_DATA_FLUXAXIS_ACC_STATERR             = 303;
    static public final int   SEG_DATA_FLUXAXIS_ACC_SYSERR              = 304;
    static public final int   SEG_DATA_FLUXAXIS_ACC_CONFIDENCE          = 305;
    static public final int   SEG_DATA_FLUXAXIS_RESOLUTION              = 306;

    static public final int   SEG_DATA_SPECTRALAXIS                     = 307;
    static public final int   SEG_DATA_SPECTRALAXIS_VALUE               = 308;
    static public final int   SEG_DATA_SPECTRALAXIS_UNIT                = 309;
    static public final int   SEG_DATA_SPECTRALAXIS_UCD                 = 310;
    static public final int   SEG_DATA_SPECTRALAXIS_ACC                 = 311;
    static public final int   SEG_DATA_SPECTRALAXIS_ACC_STATERR         = 312;
    static public final int   SEG_DATA_SPECTRALAXIS_ACC_STATERRLOW      = 313;
    static public final int   SEG_DATA_SPECTRALAXIS_ACC_STATERRHIGH     = 314;
    static public final int   SEG_DATA_SPECTRALAXIS_ACC_BINLOW          = 315;
    static public final int   SEG_DATA_SPECTRALAXIS_ACC_BINHIGH         = 316;
    static public final int   SEG_DATA_SPECTRALAXIS_ACC_BINSIZE         = 317;
    static public final int   SEG_DATA_SPECTRALAXIS_ACC_SYSERR          = 318;
    static public final int   SEG_DATA_SPECTRALAXIS_RESOLUTION          = 319;
    static public final int   SEG_DATA_SPECTRALAXIS_ACC_CONFIDENCE      = 320;

    static public final int   SEG_DATA_TIMEAXIS                         = 321;
    static public final int   SEG_DATA_TIMEAXIS_VALUE                   = 322;
    static public final int   SEG_DATA_TIMEAXIS_UNIT                    = 323;
    static public final int   SEG_DATA_TIMEAXIS_UCD                     = 324;
    static public final int   SEG_DATA_TIMEAXIS_ACC                     = 325;
    static public final int   SEG_DATA_TIMEAXIS_ACC_STATERR             = 326;
    static public final int   SEG_DATA_TIMEAXIS_ACC_STATERRLOW          = 327;
    static public final int   SEG_DATA_TIMEAXIS_ACC_STATERRHIGH         = 328;
    static public final int   SEG_DATA_TIMEAXIS_ACC_SYSERR              = 329;
    static public final int   SEG_DATA_TIMEAXIS_ACC_BINLOW              = 330;
    static public final int   SEG_DATA_TIMEAXIS_ACC_BINHIGH             = 331;
    static public final int   SEG_DATA_TIMEAXIS_ACC_BINSIZE             = 332;
    static public final int   SEG_DATA_TIMEAXIS_RESOLUTION              = 333;

    static public final int   SEG_DATA_BGM                              = 334;
    static public final int   SEG_DATA_BGM_VALUE                        = 335;
    static public final int   SEG_DATA_BGM_UNIT                         = 336;
    static public final int   SEG_DATA_BGM_UCD                          = 337;
    static public final int   SEG_DATA_BGM_QUALITY                      = 338;
    static public final int   SEG_DATA_BGM_ACC                          = 339;
    static public final int   SEG_DATA_BGM_ACC_STATERR                  = 340;
    static public final int   SEG_DATA_BGM_ACC_STATERRLOW               = 341;
    static public final int   SEG_DATA_BGM_ACC_STATERRHIGH              = 342;
    static public final int   SEG_DATA_BGM_ACC_SYSERR                   = 343;
    static public final int   SEG_DATA_BGM_RESOLUTION                   = 344;
    static public final int   SEG_DATA_BGM_ACC_BINLOW                   = 345;
    static public final int   SEG_DATA_BGM_ACC_BINHIGH                  = 346;
    static public final int   SEG_DATA_BGM_ACC_BINSIZE                  = 347;
    static public final int   SEG_DATA_BGM_ACC_CONFIDENCE               = 348;

    static public final int   SEG_CHAR_CHARAXIS_ACC_BINLOW              = 349;
    static public final int   SEG_CHAR_CHARAXIS_ACC_BINHIGH             = 350;
    static public final int   SEG_CHAR_CHARAXIS_ACC_STATERRLOW          = 351;
    static public final int   SEG_CHAR_CHARAXIS_ACC_STATERRHIGH         = 352;
    static public final int   SEG_CHAR_CHARAXIS_ACC_CONFIDENCE          = 353;
    static public final int   SEG_CHAR_CHARAXIS_SAMPPREC_SAMPPRECREFVAL_FILL = 354;
    static public final int   SEG_CHAR_CHARAXIS_COV_SUPPORT_EXTENT      = 355;
    static public final int   SEG_CHAR_CHARAXIS_COV_LOC_ACC_SYSERR      = 356;
    static public final int   SEG_CHAR_CHARAXIS_COV_LOC_ACC_CONFIDENCE  = 357;
    static public final int   SEG_CHAR_CHARAXIS_COV_LOC_ACC_BINSIZE     = 358;
    static public final int   SEG_CHAR_CHARAXIS_COV_LOC_ACC_BINLOW      = 359;
    static public final int   SEG_CHAR_CHARAXIS_COV_LOC_ACC_BINHIGH     = 360;
    static public final int   SEG_CHAR_CHARAXIS_COV_LOC_ACC_STATERR     = 361;
    static public final int   SEG_CHAR_CHARAXIS_COV_LOC_ACC_STATERRLOW  = 362;
    static public final int   SEG_CHAR_CHARAXIS_COV_LOC_ACC_STATERRHIGH = 363;
    static public final int   SEG_CHAR_CHARAXIS_COV_LOC_RESOLUTION      = 364;
    static public final int   SEG_CHAR_CHARAXIS_COV_LOC_ACC             = 365;
    static public final int   SEG_CHAR_CHARAXIS_COV_SUPPORT_RANGE       = 366;
    static public final int   SEG                                       = 367;
    static public final int   SPEC                                      = 368;
    static public final int   CUSTOM                                    = 369;
    ...
    static
    {
        ...
        name[SEG_DATA_FLUXAXIS_UNIT] = "Spectrum.Data.FluxAxis.Unit";
        name[SEG_DATA_FLUXAXIS_UCD] = "Spectrum.Data.FluxAxis.UCD";
        ...
        name[SEG_DATA_SPECTRALAXIS_UNIT] = "Spectrum.Data.SpectralAxis.Unit";
        name[SEG_DATA_SPECTRALAXIS_UCD] = "Spectrum.Data.SpectralAxis.UCD";
        ...
        name[SEG_DATA_TIMEAXIS_UNIT] = "Spectrum.Data.TimeAxis.Unit";
        name[SEG_DATA_TIMEAXIS_UCD] = "Spectrum.Data.TimeAxis.UCD";
        ...
        name[SEG_DATA_BGM_UNIT] = "Spectrum.Data.BackgroundModel.Unit";
        name[SEG_DATA_BGM_UCD] = "Spectrum.Data.BackgroundModel.UCD";
